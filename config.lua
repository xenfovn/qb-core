...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 40) -- Gets max players from config file, default 64
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { ['cash'] = 2000, ['bank'] = 13000, ['crypto'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto' } -- Money that is not allowed going in minus
QBConfig.Money.PayCheckTimeOut = 10 -- The time in minutes that it will give the paycheck

QBConfig.PayEmail = false
...
QBConfig.testuser = GetConvarInt('testuser', 0)
