...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.charinfo.account = PlayerData.charinfo.account ~= nil and PlayerData.charinfo.account or 'BANK' .. math.random(111111111, 999999999)
    -- Metadata
    ...
    PlayerData.metadata['membership'] = PlayerData.metadata['membership'] or false
    ...
    PlayerData.metadata['mission'] = PlayerData.metadata['mission'] or 0
